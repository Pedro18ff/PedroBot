...
const smsLista1 = () => { return `🌟 INFORMACIÓN DE PEDRO_BOT 🌟`}
...
const smsLista7 = () => { return `🐈 INSTALAR PEDRO-BOT 🐈`}
...
//_allantilink.js
const smsTextoYT = () => { return '😻 𝗦𝘂𝗽𝗲𝗿 PedroBot-𝗠𝗗 - 𝗪𝗵𝗮𝘁𝘀𝗔𝗽𝗽 '} 
...
const ePedroCoins = () => { return '🐱 Pedro Coins' }
const eGataTickers = () => { return '🎫 Pedro Tickets' } 
...
const smsContacto2 = () => { return 'Soy Pedro de ' + packname + ' sí tienes alguna duda me la puedes decir ✌️'}
const smsContacto3 = () => { return '👑 Owner'}
const smsContacto4 = () => { return 'Contacto Oficial de PedroBot 🐈'}
